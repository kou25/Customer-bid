...
export default function Profile() {
  ...
  const getCustomerProfileLoading = useSelector(
    (state) => state.CustomerReducer.getCustomerProfileLoading
  );
  ...
  return (
    <>
      <Spin spinning={getCustomerProfileLoading}>
        <div className="glass">
          <div class="dashboard">
            <div class="user">
                ...
                getCustomerProfileData?.bids.map((data) => (
                  <div class="card">
                    ...
                    <div style={{ display: "block" }}>
                      <Progress
                        percent={((data?.amount / 300000) * 100).toFixed(1)}
                        size="small"
                        status="active"
                      />
                    </div>
